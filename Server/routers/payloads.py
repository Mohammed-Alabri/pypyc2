...
def get_agent_payload():
    ...
    """
    # In Docker, agent file is copied to Server/files/
    # In dev mode, try both locations
    agent_path = Path(__file__).parent.parent / "files" / "allinone.py"

    # Fallback to original location for non-Docker dev environment
